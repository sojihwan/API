    ...
    <div className="taxt">
    {
            ...
            return(
              ...
              <img className="bookimg" onClick={model} src={
                api.data.list[index].thumbnailUrl != null? api.data.list[index].thumbnailUrl:
                api.data.list[index].thumbnailUrl != undefined? api.data.list[index].thumbnailUrl:
                api.data.list[index].thumbnailUrl.startsWith('http')?api.data.list[index].thumbnailUrl:
                'img/ddd.jpg'
              }
              /><br/>
