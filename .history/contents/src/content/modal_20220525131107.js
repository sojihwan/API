      ...
      <div id="modal" className="modal-overlay" onClick={overlay_Close}>
        <div className="modal-window">
          ...
          <div className="content">
            ...
            <b id="similars" className="ModalText">{props.id.similars[0].titleStatement!=null ? props.id.similars[0].titleStatement : "?왜갑"}<br/><br/>{props.id.similars[1].titleStatement}<br/><br/>{props.id.similars[2].titleStatement}</b>
          </div>
        </div>
      </div>
    </div>
