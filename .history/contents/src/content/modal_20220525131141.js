      ...
      <div id="modal" className="modal-overlay" onClick={overlay_Close}>
        <div className="modal-window">
          ...
          <div className="content">
            ...
            <br/><br/>
            {props.id.similars[1].titleStatement!=null ? props.id.similars[0].titleStatement : "?왜 값이 없지"}
            <br/><br/>
            {props.id.similars[0].titleStatement!=null ? props.id.similars[0].titleStatement : "?왜 값이 없지"}
            </b>
          </div>
        </div>
      </div>
