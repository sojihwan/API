      ...
      <div id="modal" className="modal-overlay" onClick={overlay_Close}>
        <div className="modal-window">
          ...
          <div className="content">
            ...
            <b id="similars" className="ModalText">{props.id.similars===undefined? "" : props.id.similars[0]===null? "" : props.id.similars[0].titleStatement}<br/><br/>{props.id.similars===undefined? null : props.id.similars[1].titleStatement}<br/><br/>{props.id.similars===undefined? null : props.id.similars[2].titleStatement}</b>
            <b>{props.id.id}</b>
