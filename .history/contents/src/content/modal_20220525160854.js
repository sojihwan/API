      ...
      <div id="modal" className="modal-overlay" onClick={overlay_Close}>
        <div className="modal-window">
          ...
          <div className="content">
            ...
            props.id.similars[0]===null? "추천도서가 없습니다" : 
            props.id.similars[0].titleStatement}<br/><br/>{props.id.similars===undefined? null : props.id.similars[1].titleStatement}<br/><br/>{props.id.similars===undefined? null : props.id.similars[2].titleStatement}</b>
            <b>{props.id.id}</b>
