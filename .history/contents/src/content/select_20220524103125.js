            ...
            users.data.list.map((item,index) => {
              return(
                <div className="img" onClick={model} key={index}>
                  <img className="bookimg" src={(users.data.list[index].thumbnailUrl != null)?users.data.list[index].thumbnailUrl:"C:\Users\SMC_SW_N_14\Documents\GitHub\DBMS\API\contents\src\content\Ifnull.png"}/><br/>
