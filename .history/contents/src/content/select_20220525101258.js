            ...
            users.data.list.map((item,index) => {
              return(
                <div className="img" key={index}>
                  <img className="bookimg" onClick={mode l&&idgive(users.data.list[index])} src={(users.data.list[index].thumbnailUrl != null)?users.data.list[index].thumbnailUrl:'img/ddd.jpg'}
                  /><br/>
